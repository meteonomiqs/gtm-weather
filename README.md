...
In case you do not have a CMP, just select 'All Custom Events' instead of 'Some Custom Event' adn ignore the CMP.Google Analytics condition in 'Weathertag Trigger - Fill Datalayer'. 
